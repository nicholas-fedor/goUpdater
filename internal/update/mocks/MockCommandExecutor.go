...
func (_mock *MockCommandExecutor) CommandContext(ctx context.Context, name string, arg ...string) exec.Command {
	...
	var r0 exec.Command
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, ...string) exec.Command); ok {
...
func (_c *MockCommandExecutor_CommandContext_Call) Return(command exec.Command) *MockCommandExecutor_CommandContext_Call {
	_c.Call.Return(command)
	return _c
}

func (_c *MockCommandExecutor_CommandContext_Call) RunAndReturn(run func(ctx context.Context, name string, arg ...string) exec.Command) *MockCommandExecutor_CommandContext_Call {
	_c.Call.Return(run)
	return _c
}
