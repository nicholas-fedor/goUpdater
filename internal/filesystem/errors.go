...
var (
	...
	ErrRemoveAll = errors.New("failed to remove all")
	...
	ErrChangeMode = errors.New("failed to change mode")
	...
	ErrLstatFile = errors.New("failed to lstat file")
	// ErrEvalSymlinks indicates failure to evaluate symlinks.
	ErrEvalSymlinks = errors.New("failed to evaluate symlinks")
	...
	ErrCreateHardLink = errors.New("failed to create hard link")
	...
	ErrHomeNotSet = errors.New("HOME not set")
